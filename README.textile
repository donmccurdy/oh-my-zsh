...
The sole purpose of this fork is to track my slight alterations to the "Agnoster" theme. More specifically I've cut the prompt to a minimum, which I prefer simply because it takes up less space. This is helpful when using a split-terminal like "iTerm 2":http://www.iterm2.com or "tmux":http://tmux.sourceforge.net/. If I need to see the full path, I just type `pwd`.
